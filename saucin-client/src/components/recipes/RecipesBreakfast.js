...
import Breakfast from '../../img/category-breakfast.jpg';
...
const RecipesBreakfast = ({ getRecipesBreakfast, recipe: { recipes, loading } }) => {
    ...
    return (
        loading ? (
            ...
            <LazyLoadImage className="lg:h-screen md:h-screen sm:h-1/2 w-full" effect="blur" src={Breakfast}></LazyLoadImage>
            </div>
