...
import Dessert from '../../img/dessert-category.jpg'
...
const RecipesDessert = ({ getRecipesDessert, recipe: { recipes, loading } }) => {
    ...
    return (
        loading ? (
            ...
            <LazyLoadImage className="lg:h-screen md:h-screen sm:h-1/2 w-full" effect="blur" src={Dessert}></LazyLoadImage>
            </div>
            <div className="dessert-recipes second-column">
