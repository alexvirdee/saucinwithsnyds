...
const Navbar = () => {
  return (
    <header className="lg:px-16 px-6 bg-white flex flex-wrap items-center lg:py-0 py-2 h-min-full lg:h-8">
      <div className="flex-1 flex justify-between items-center">
        <a href="#">
          <img className="logo" src={logo} alt="saucinwithsnyds logo" />
        </a>
      </div>
      ...
      >
        <nav>
          <ul className="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
            ...
            <li>
              <a
                className="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-black lg:mb-0 mb-2"
                href="#"
              >
                Login
              </a>
